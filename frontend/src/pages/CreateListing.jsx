...
import '../Style/CreateListings.css';
 ...
 const handleSelectAmenities = (facility) => {
  if (amenities.includes(facility)) {
   ...
   const handleDragPhoto=(result)=>{
    ...
    const {reorderedItem}=items.splice(result.sourc.index,1)
  ...
  const handeleChangeDescription=(e)=>{
    const {name,value}=e.target
    setFormDescription({
      ...formDescription,
      [name]:value
      ...
      <div className='create-listing'>
        ...
        <form onSubmit={handlePost}>
          <div className='create-listing_step1'>
            <h2>Step 1: Tell us about place</h2>
            <hr />
           ...
           <DragDropContext onDragEnd={handleDragPhoto}>
            <Droppable droppableId='photos' direction='horizontal'>
              ...
              <div className='description'>
                <p>Title</p>
                <input type="text" placeholder='Title' name="title"  value={formDescription.title} onChange={handeleChangeDescription} required/>
                <p>Description</p>
                <textarea type="text" placeholder='Description' name="description"  value={formDescription.description} onChange={handeleChangeDescription} required/>
                <p>Highlight</p>
                <input type="text" placeholder='Highlight' name="highlight" value={formDescription.highlight} onChange={handeleChangeDescription} required/>
                <p>Highlight details</p>
                <textarea type="text" placeholder='Highlight details'  name="highlightDesc" value={formDescription.highlightDesc} onChange={handeleChangeDescription} required/>
                <p>Now,set your PRICE</p>
                <span>$</span>
                <input type="number" placeholder='100' name='price' className='price' value={formDescription.price} onChange={handeleChangeDescription} required/>
              </div>
