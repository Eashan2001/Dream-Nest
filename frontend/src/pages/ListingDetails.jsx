    ...
    <>
      ...
      <div className="listing-details">
        ...
        <div className="profile">
          <img
            src={`http://localhost:3000/${listing.creator.profileImagePath.replace("public", "")}`}
            alt="host profile"
          />
          <h3>
          ...
          <div>
            ...
            <div className="amenities">
              {listing.amenities[0].split(",").map((item, index) => {
                ...
                const facility = facilities.find((facility) => facility.name === trimmedItem);

                return (
                  <div className="facility" key={index}>
                    <div className="facility_icon">
                      {facility ? React.createElement(facility.icon) : <span>Icon not found</span>}
                    </div>
                    <p>{trimmedItem}</p>
                  </div>
                );
